...
class CustomDate(year: Int = 2000, month: Int = 10, day: Int = 1) {
    ...
    constructor(localDate: LocalDate): this(localDate.year, localDate.monthValue, localDate.dayOfMonth)
    constructor(stringFormat: String) : this(LocalDate.parse(stringFormat))
